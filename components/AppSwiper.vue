    ...
    data() {
      return {
          banners: {
            ...
            5: { id: "7", name: 'Николай Зинин', desc: 'Риэлтор' }, 
            6: { id: "8", name: 'Виктория Мельникова', desc: 'Менеджер по прямым продажам' }, 
            7: { id: "9", name: 'Нина Ступкина', desc: 'Риэлтор' }, 
            8: { id: "10", name: 'Марина Геннадьевна', desc: 'Юрист' }, 
          },
          trans: '',
        // swiperOption: {
