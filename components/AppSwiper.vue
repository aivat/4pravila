...
export default {
    data() {
      return {
          banners: {
            ...
            5: { id: "6", name: 'Роман Усманов', desc: 'Риэлтор' }, 
            6: { id: "7", name: 'Николай Зинин', desc: 'Риэлтор' }, 
            7: { id: "8", name: 'Виктория Мельникова', desc: 'Менеджер по прямым продажам' }, 
            8: { id: "9", name: 'Нина Ступкина', desc: 'Риэлтор' }, 
            9: { id: "10", name: 'Марина Геннадьевна', desc: 'Юрист' }, 
          },
          trans: '',
        // swiperOption: {
    ...
    methods: {
        path(name) {
            return require('~/assets/img/slide_em/' + name + '.png')
        },
        flipover(id) {
            // console.log('id=', id)
            // this.trans = 'translate3d(-100px, 0px, 0px)'
            if ( id === 1 ) {
                this.trans = 'translate3d(-100px, 0px, 0px)'
            }            
            if ( id === -1 ) {
                this.trans = 'translate3d(0px, 0px, 0px)'
            }
            console.log('Айвати')
        }
    }
